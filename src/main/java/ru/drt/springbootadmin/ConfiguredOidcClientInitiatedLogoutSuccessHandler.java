 ...
 * <p>
 * PROKVAL:
 * Modified version of OidcClientInitiatedLogoutSuccessHandler. Need to override endSessionEndpoint method
 * to get URL from the config.
 *
 ...
 *
 */
public class ConfiguredOidcClientInitiatedLogoutSuccessHandler extends SimpleUrlLogoutSuccessHandler {
	...
	public ConfiguredOidcClientInitiatedLogoutSuccessHandler(ClientRegistrationRepository clientRegistrationRepository) {
	...
	private URI endSessionEndpoint(ClientRegistration clientRegistration) {
		if (clientRegistration != null) {
			...
			} else if (endSessionEndpointUri != null) {
